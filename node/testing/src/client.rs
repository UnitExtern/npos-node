...
//! Utilities to build a `TestClient` for `clarus-runtime`.

use sp_runtime::BuildStorage;
/// Re-export test-client utilities.
pub use substrate_test_client::*;

/// Call executor for `clarus-runtime` `TestClient`.
...
pub type Client = client::Client<
    Backend,
	client::LocalCallExecutor<node_primitives::Block, Backend, RuntimeExecutor>,    node_primitives::Block,
...
impl TestClientBuilderExt
    for substrate_test_client::TestClientBuilder<
		...
		client::LocalCallExecutor<node_primitives::Block, Backend, RuntimeExecutor>,        Backend,
        GenesisParameters,
    >
{
    fn new() -> Self {
