...
pub fn create_extrinsic(
    ...
    function: impl Into<clarus_runtime::RuntimeCall>,
    nonce: Option<u32>,
) -> clarus_runtime::UncheckedExtrinsic {
    ...
    let period = clarus_runtime::BlockHashCount::get()
        .checked_next_power_of_two()
        .map(|c| c / 2)
        .unwrap_or(2) as u64;
    let tip = 0;
    let extra: clarus_runtime::SignedExtra = (
        frame_system::CheckNonZeroSender::<clarus_runtime::Runtime>::new(),
        frame_system::CheckSpecVersion::<clarus_runtime::Runtime>::new(),
        frame_system::CheckTxVersion::<clarus_runtime::Runtime>::new(),
        frame_system::CheckGenesis::<clarus_runtime::Runtime>::new(),
        frame_system::CheckEra::<clarus_runtime::Runtime>::from(generic::Era::mortal(
            period,
    ...
    let raw_payload = clarus_runtime::SignedPayload::from_raw(
        ...
        (
            (),
            clarus_runtime::VERSION.spec_version,
            clarus_runtime::VERSION.transaction_version,
            genesis_hash,
            best_hash,
            (),
            (),
    ...
    clarus_runtime::UncheckedExtrinsic::new_signed(
        function,
        sp_runtime::AccountId32::from(sender.public()).into(),
        clarus_runtime::Signature::Sr25519(signature),
        extra,
    )
}
